/**
 * Page component for the S el le rP ro fi le Pa ge route and related page-level interactions.
 */
...
export default function SellerProfilePage() {
  ...
  useEffect(() => {
    ...
    if (found) {
      setSeller(found);
      setSellerProducts(products.filter(p => p.seller.id === sellerId).slice(0, 4));
    }
  }, [sellerId]);
