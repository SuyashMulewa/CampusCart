/**
 * Page component for the H om eP ag e route and related page-level interactions.
 */
...
export default function HomePage() {
  const [freshListings] = useState(products.slice(4, 8));
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/30 backdrop-blur-[2px]">
          <div className="bg-white w-full max-w-md rounded-2xl border border-gray-100 shadow-2xl p-8 flex flex-col gap-6">
            ...
            <Button
              ...
              onClick={() => {
                toast.success('Thank you for your review!', { duration: 3000 });
                setShowReview(false);
              }}
            >
              Submit Review
