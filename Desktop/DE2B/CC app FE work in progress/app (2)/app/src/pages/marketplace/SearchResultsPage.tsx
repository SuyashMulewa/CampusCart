/**
 * Page component for the S ea rc hR es ul ts Pa ge route and related page-level interactions.
 */
...
export default function SearchResultsPage() {
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      ...
      const catObj = categories.find(cat => cat.id === selectedCategory || cat.name.toLowerCase() === selectedCategory.toLowerCase());
      if (catObj) {
  ...
  }, [query, selectedCategory, selectedConditions, selectedPriceRange, sortBy, categories]);
