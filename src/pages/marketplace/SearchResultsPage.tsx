...
import { Search, BookOpen, GraduationCap, Pencil } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="mb-6 bg-white rounded-2xl border border-gray-100 p-6 md:p-8 relative flex flex-row items-center gap-8 min-h-[220px]">
          {/* Illustration left */}
          <div className="w-[340px] h-[180px] rounded-2xl overflow-hidden flex-shrink-0">
            <img
          ...
          <div className="flex-1 flex flex-col justify-center relative">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 relative z-10">
              Find everything you need on <span className="text-[#F5B800]">CampusCart</span>
            </h1>
            <p className="text-gray-600 text-lg max-w-xl relative z-10">Get everything you need for your studies, from textbooks to electronics.</p>
            {/* Floating icons */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
              transition={{ duration: 3, repeat: Infinity }}
              className="absolute -top-16 left-1/5 -translate-x-1/2 w-16 h-16 bg-white rounded-2xl shadow-lg flex items-center justify-center z-20"
            >
            ...
            <motion.div
              ...
              className="absolute top-0 right-0 w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center z-20"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-16 left-1/2 translate-x-[-60%] w-12 h-12 bg-white rounded-xl shadow-lg flex items-center justify-center z-20"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px,1fr] gap-6 items-start">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4 h-fit">
              ...
              <div className="mb-5">
                ...
                <select
                  ...
                  className="px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#F5B800]/30 outline-none"
                >
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl border border-gray-100 min-h-[460px] p-4 sm:p-6">
              {filteredProducts.length > 0 ? (
                ...
                <div className="h-full min-h-[580px] flex flex-col items-center justify-center text-center">
